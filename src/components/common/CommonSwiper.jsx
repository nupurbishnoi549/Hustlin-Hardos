    ...
    return (
        <>
            <div className="container max-w-[1172px] mx-auto px-4 relative">
                ...
                <button className="custom-next absolute top-[45%] cursor-pointer max-sm:top-[35%] right-[4%] xl:right-0 z-10 w-[18px] h-9">
                ...
                <div className={`w-full ${!isTweets ? 'bg-[url("../src/assets/images/png/bg-team-img.png")] bg-no-repeat bg-cover bg-center' : ''}`}>
                    <Swiper
                        ...
                        breakpoints={{
                            0: { slidesPerView: 1 },
                            768: { slidesPerView: 2 },
                            1024: { slidesPerView: isTweets ? 3 : 2 },
                        }}
                    >
                        {data.map((item, index) => (
                            <SwiperSlide key={index}>
                                <div
                                    className={`border-black p-[26px]  border-r-2 ${isTweets
                                        ? 'flex flex-col items-start justify-center h-[259px]'
                                        : 'flex flex-col items-center justify-center h-[326px]'
                                        }`}
                                >
                                    {!isTweets && (
                                        <img
