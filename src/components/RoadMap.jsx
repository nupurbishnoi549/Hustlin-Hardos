...
const Roadmap = () => {
    return (
        <div id="roadmap">
            ...
            <div className="relative flex flex-col items-center container max-w-[1140px] mx-auto max-xl:px-4 pl-4 xl:border-x-2 lg:pt-[99px] pt-10 xl:pb-[300px] lg:pb-[120px] md:pb-[40px] pb-8">
                ...
                {ROADMAP_DATA.map((item, index) => (
                    <div
                        ...
                        <div
                            ...
                            <p className="md:text-sm text-xs mb-2">{item.phase}</p>
                            <h2 className="lg:text-4xl text-2xl leading-[110%] font-semibold mb-2">{item.title}</h2>
                            <p className="text-black lg:text-base text-sm md:pr-2">{item.description}</p>
                        </div>
